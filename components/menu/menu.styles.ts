...
export const styles = StyleSheet.create({
  ...
  piHeroAvatarFallback: {
    width: '100%',
    height: '100%',
    borderRadius: 24,
    alignItems: 'center',
    justifyContent: 'center',
    backgroundColor: 'rgba(118, 113, 255, 0.2)',
    borderWidth: StyleSheet.hairlineWidth,
    borderColor: 'rgba(184, 188, 255, 0.45)',
  },
  piHeroAvatarInitials: {
    color: '#ffffff',
    fontSize: 22,
    fontWeight: '900',
  },
  ...
  photoModalTileIconWrapActive: {
    backgroundColor: "rgba(91, 95, 239, 0.15)",
  },
  photoModalTileIconWrapDestructive: {
